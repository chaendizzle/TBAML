...
public class InvAddToken extends Token
{
	String rawA;
	String rawB;
	...
	public InvAddToken(String rawA, String rawB, int depth, Compiler compiler)
	{
	...
	{
		// check inv
		((Inventory) A.evaluate(interpreter)).add((String) B.evaluate(interpreter));
		return null;
	}
}
